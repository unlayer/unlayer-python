...
class TestProjectV1:
    ...
    def test_method_api_keys_create(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.api_keys_create(
            name="name",
        )
        assert_matches_type(ProjectV1APIKeysCreateResponse, project_v1, path=["response"])
    ...
    def test_raw_response_api_keys_create(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.api_keys_create(
            name="name",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        project_v1 = response.parse()
        assert_matches_type(ProjectV1APIKeysCreateResponse, project_v1, path=["response"])

    @parametrize
    def test_streaming_response_api_keys_create(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.api_keys_create(
            name="name",
        ) as response:
    ...
    def test_method_api_keys_delete(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.api_keys_delete(
            "id",
        )
        assert project_v1 is None

    @parametrize
    def test_raw_response_api_keys_delete(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.api_keys_delete(
            "id",
        )
    ...
    def test_streaming_response_api_keys_delete(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.api_keys_delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_api_keys_delete(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.project_v1.with_raw_response.api_keys_delete(
                "",
            )

    @parametrize
    def test_method_api_keys_list(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.api_keys_list()
        assert_matches_type(ProjectV1APIKeysListResponse, project_v1, path=["response"])

    @parametrize
    def test_raw_response_api_keys_list(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.api_keys_list()
    ...
    def test_streaming_response_api_keys_list(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.api_keys_list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_api_keys_retrieve(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.api_keys_retrieve(
            "id",
        )
        assert_matches_type(ProjectV1APIKeysRetrieveResponse, project_v1, path=["response"])

    @parametrize
    def test_raw_response_api_keys_retrieve(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.api_keys_retrieve(
            "id",
        )
    ...
    def test_streaming_response_api_keys_retrieve(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.api_keys_retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_api_keys_retrieve(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.project_v1.with_raw_response.api_keys_retrieve(
                "",
            )

    @parametrize
    def test_method_api_keys_update(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.api_keys_update(
            id="id",
        )
        assert_matches_type(ProjectV1APIKeysUpdateResponse, project_v1, path=["response"])
    ...
    def test_raw_response_api_keys_update(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.api_keys_update(
            id="id",
        )
    ...
    def test_streaming_response_api_keys_update(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.api_keys_update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_api_keys_update(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.project_v1.with_raw_response.api_keys_update(
                id="",
            )

    @parametrize
    def test_method_current_list(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.current_list()
        assert_matches_type(ProjectV1CurrentListResponse, project_v1, path=["response"])

    @parametrize
    def test_raw_response_current_list(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.current_list()
    ...
    def test_streaming_response_current_list(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.current_list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_domains_create(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.domains_create(
            domain="domain",
        )
        assert_matches_type(ProjectV1DomainsCreateResponse, project_v1, path=["response"])

    @parametrize
    def test_raw_response_domains_create(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.domains_create(
            domain="domain",
        )
    ...
    def test_streaming_response_domains_create(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.domains_create(
            domain="domain",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_domains_delete(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.domains_delete(
            "id",
        )
        assert project_v1 is None
    ...
    def test_raw_response_domains_delete(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.domains_delete(
            "id",
        )
    ...
    def test_streaming_response_domains_delete(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.domains_delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_domains_delete(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.project_v1.with_raw_response.domains_delete(
                "",
            )

    @parametrize
    def test_method_domains_list(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.domains_list()
        assert_matches_type(ProjectV1DomainsListResponse, project_v1, path=["response"])

    @parametrize
    def test_raw_response_domains_list(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.domains_list()
    ...
    def test_streaming_response_domains_list(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.domains_list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_domains_retrieve(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.domains_retrieve(
            "id",
        )
        assert_matches_type(ProjectV1DomainsRetrieveResponse, project_v1, path=["response"])

    @parametrize
    def test_raw_response_domains_retrieve(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.domains_retrieve(
            "id",
        )
    ...
    def test_streaming_response_domains_retrieve(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.domains_retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_domains_retrieve(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.project_v1.with_raw_response.domains_retrieve(
                "",
            )

    @parametrize
    def test_method_domains_update(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.domains_update(
            id="id",
        )
        assert_matches_type(ProjectV1DomainsUpdateResponse, project_v1, path=["response"])
    ...
    def test_raw_response_domains_update(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.domains_update(
            id="id",
        )
    ...
    def test_streaming_response_domains_update(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.domains_update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_domains_update(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.project_v1.with_raw_response.domains_update(
                id="",
            )

    @parametrize
    def test_method_templates_create(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.templates_create(
            name="name",
        )
        assert_matches_type(ProjectV1TemplatesCreateResponse, project_v1, path=["response"])
    ...
    def test_raw_response_templates_create(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.templates_create(
            name="name",
        )
    ...
    def test_streaming_response_templates_create(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.templates_create(
            name="name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_templates_delete(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.templates_delete(
            "id",
        )
        assert project_v1 is None
    ...
    def test_raw_response_templates_delete(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.templates_delete(
            "id",
        )
    ...
    def test_streaming_response_templates_delete(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.templates_delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_templates_delete(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.project_v1.with_raw_response.templates_delete(
                "",
            )

    @parametrize
    def test_method_templates_list(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.templates_list()
        assert_matches_type(ProjectV1TemplatesListResponse, project_v1, path=["response"])

    @parametrize
    def test_raw_response_templates_list(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.templates_list()
    ...
    def test_streaming_response_templates_list(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.templates_list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_templates_retrieve(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.templates_retrieve(
            "id",
        )
        assert_matches_type(ProjectV1TemplatesRetrieveResponse, project_v1, path=["response"])

    @parametrize
    def test_raw_response_templates_retrieve(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.templates_retrieve(
            "id",
        )
    ...
    def test_streaming_response_templates_retrieve(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.templates_retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_templates_retrieve(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.project_v1.with_raw_response.templates_retrieve(
                "",
            )

    @parametrize
    def test_method_templates_update(self, client: Unlayer) -> None:
        project_v1 = client.project_v1.templates_update(
            id="id",
        )
        assert_matches_type(ProjectV1TemplatesUpdateResponse, project_v1, path=["response"])
    ...
    def test_raw_response_templates_update(self, client: Unlayer) -> None:
        response = client.project_v1.with_raw_response.templates_update(
            id="id",
        )
    ...
    def test_streaming_response_templates_update(self, client: Unlayer) -> None:
        with client.project_v1.with_streaming_response.templates_update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_templates_update(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.project_v1.with_raw_response.templates_update(
                id="",
            )


class TestAsyncProjectV1:
    ...
    async def test_method_api_keys_create(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.api_keys_create(
            name="name",
        )
        assert_matches_type(ProjectV1APIKeysCreateResponse, project_v1, path=["response"])
    ...
    async def test_raw_response_api_keys_create(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.api_keys_create(
            name="name",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        project_v1 = await response.parse()
        assert_matches_type(ProjectV1APIKeysCreateResponse, project_v1, path=["response"])

    @parametrize
    async def test_streaming_response_api_keys_create(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.api_keys_create(
            name="name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_api_keys_delete(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.api_keys_delete(
            "id",
        )
        assert project_v1 is None
    ...
    async def test_raw_response_api_keys_delete(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.api_keys_delete(
            "id",
        )
    ...
    async def test_streaming_response_api_keys_delete(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.api_keys_delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_api_keys_delete(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.project_v1.with_raw_response.api_keys_delete(
                "",
            )

    @parametrize
    async def test_method_api_keys_list(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.api_keys_list()
        assert_matches_type(ProjectV1APIKeysListResponse, project_v1, path=["response"])

    @parametrize
    async def test_raw_response_api_keys_list(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.api_keys_list()
    ...
    async def test_streaming_response_api_keys_list(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.api_keys_list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_api_keys_retrieve(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.api_keys_retrieve(
            "id",
        )
        assert_matches_type(ProjectV1APIKeysRetrieveResponse, project_v1, path=["response"])
    ...
    async def test_raw_response_api_keys_retrieve(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.api_keys_retrieve(
            "id",
        )
    ...
    async def test_streaming_response_api_keys_retrieve(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.api_keys_retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_api_keys_retrieve(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.project_v1.with_raw_response.api_keys_retrieve(
                "",
            )

    @parametrize
    async def test_method_api_keys_update(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.api_keys_update(
            id="id",
        )
        assert_matches_type(ProjectV1APIKeysUpdateResponse, project_v1, path=["response"])
    ...
    async def test_raw_response_api_keys_update(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.api_keys_update(
            id="id",
        )
    ...
    async def test_streaming_response_api_keys_update(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.api_keys_update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_api_keys_update(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.project_v1.with_raw_response.api_keys_update(
                id="",
            )

    @parametrize
    async def test_method_current_list(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.current_list()
        assert_matches_type(ProjectV1CurrentListResponse, project_v1, path=["response"])

    @parametrize
    async def test_raw_response_current_list(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.current_list()
    ...
    async def test_streaming_response_current_list(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.current_list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_domains_create(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.domains_create(
            domain="domain",
        )
        assert_matches_type(ProjectV1DomainsCreateResponse, project_v1, path=["response"])
    ...
    async def test_raw_response_domains_create(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.domains_create(
            domain="domain",
        )
    ...
    async def test_streaming_response_domains_create(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.domains_create(
            domain="domain",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_domains_delete(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.domains_delete(
            "id",
        )
        assert project_v1 is None
    ...
    async def test_raw_response_domains_delete(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.domains_delete(
            "id",
        )
    ...
    async def test_streaming_response_domains_delete(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.domains_delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_domains_delete(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.project_v1.with_raw_response.domains_delete(
                "",
            )

    @parametrize
    async def test_method_domains_list(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.domains_list()
        assert_matches_type(ProjectV1DomainsListResponse, project_v1, path=["response"])

    @parametrize
    async def test_raw_response_domains_list(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.domains_list()
    ...
    async def test_streaming_response_domains_list(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.domains_list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_domains_retrieve(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.domains_retrieve(
            "id",
        )
        assert_matches_type(ProjectV1DomainsRetrieveResponse, project_v1, path=["response"])
    ...
    async def test_raw_response_domains_retrieve(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.domains_retrieve(
            "id",
        )
    ...
    async def test_streaming_response_domains_retrieve(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.domains_retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_domains_retrieve(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.project_v1.with_raw_response.domains_retrieve(
                "",
            )

    @parametrize
    async def test_method_domains_update(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.domains_update(
            id="id",
        )
        assert_matches_type(ProjectV1DomainsUpdateResponse, project_v1, path=["response"])
    ...
    async def test_raw_response_domains_update(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.domains_update(
            id="id",
        )
    ...
    async def test_streaming_response_domains_update(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.domains_update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_domains_update(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.project_v1.with_raw_response.domains_update(
                id="",
            )

    @parametrize
    async def test_method_templates_create(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.templates_create(
            name="name",
        )
        assert_matches_type(ProjectV1TemplatesCreateResponse, project_v1, path=["response"])
    ...
    async def test_raw_response_templates_create(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.templates_create(
            name="name",
        )
    ...
    async def test_streaming_response_templates_create(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.templates_create(
            name="name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_templates_delete(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.templates_delete(
            "id",
        )
        assert project_v1 is None
    ...
    async def test_raw_response_templates_delete(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.templates_delete(
            "id",
        )
    ...
    async def test_streaming_response_templates_delete(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.templates_delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_templates_delete(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.project_v1.with_raw_response.templates_delete(
                "",
            )

    @parametrize
    async def test_method_templates_list(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.templates_list()
        assert_matches_type(ProjectV1TemplatesListResponse, project_v1, path=["response"])

    @parametrize
    async def test_raw_response_templates_list(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.templates_list()
    ...
    async def test_streaming_response_templates_list(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.templates_list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_templates_retrieve(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.templates_retrieve(
            "id",
        )
        assert_matches_type(ProjectV1TemplatesRetrieveResponse, project_v1, path=["response"])
    ...
    async def test_raw_response_templates_retrieve(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.templates_retrieve(
            "id",
        )
    ...
    async def test_streaming_response_templates_retrieve(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.templates_retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_templates_retrieve(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.project_v1.with_raw_response.templates_retrieve(
                "",
            )

    @parametrize
    async def test_method_templates_update(self, async_client: AsyncUnlayer) -> None:
        project_v1 = await async_client.project_v1.templates_update(
            id="id",
        )
        assert_matches_type(ProjectV1TemplatesUpdateResponse, project_v1, path=["response"])
    ...
    async def test_raw_response_templates_update(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.project_v1.with_raw_response.templates_update(
            id="id",
        )
    ...
    async def test_streaming_response_templates_update(self, async_client: AsyncUnlayer) -> None:
        async with async_client.project_v1.with_streaming_response.templates_update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_templates_update(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.project_v1.with_raw_response.templates_update(
                id="",
            )
