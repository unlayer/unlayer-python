...
class TestVerify:
    ...
    def test_method_create(self, client: Unlayer) -> None:
        verify = client.domains.verify.create(
            "id",
        )
        assert_matches_type(VerifyCreateResponse, verify, path=["response"])

    @parametrize
    def test_raw_response_create(self, client: Unlayer) -> None:
        response = client.domains.verify.with_raw_response.create(
            "id",
        )
    ...
    def test_streaming_response_create(self, client: Unlayer) -> None:
        with client.domains.verify.with_streaming_response.create(
            "id",
        ) as response:
    ...
    def test_path_params_create(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.domains.verify.with_raw_response.create(
                "",
            )
...
class TestAsyncVerify:
    ...
    async def test_method_create(self, async_client: AsyncUnlayer) -> None:
        verify = await async_client.domains.verify.create(
            "id",
        )
        assert_matches_type(VerifyCreateResponse, verify, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.domains.verify.with_raw_response.create(
            "id",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncUnlayer) -> None:
        async with async_client.domains.verify.with_streaming_response.create(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.domains.verify.with_raw_response.create(
                "",
            )
