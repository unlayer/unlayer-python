...
class TestPagesV1:
    ...
    def test_method_render_create(self, client: Unlayer) -> None:
        pages_v1 = client.pages_v1.render_create(
            design={
                "counters": "bar",
                "body": "bar",
            },
        )
        assert_matches_type(PagesV1RenderCreateResponse, pages_v1, path=["response"])
    ...
    def test_raw_response_render_create(self, client: Unlayer) -> None:
        response = client.pages_v1.with_raw_response.render_create(
            design={
                "counters": "bar",
                "body": "bar",
            },
        ...
        pages_v1 = response.parse()
        assert_matches_type(PagesV1RenderCreateResponse, pages_v1, path=["response"])

    @parametrize
    def test_streaming_response_render_create(self, client: Unlayer) -> None:
        with client.pages_v1.with_streaming_response.render_create(
            design={
                "counters": "bar",
                "body": "bar",
            },
...
class TestAsyncPagesV1:
    ...
    async def test_method_render_create(self, async_client: AsyncUnlayer) -> None:
        pages_v1 = await async_client.pages_v1.render_create(
            design={
                "counters": "bar",
                "body": "bar",
            },
    ...
    async def test_raw_response_render_create(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.pages_v1.with_raw_response.render_create(
            design={
                "counters": "bar",
                "body": "bar",
            },
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        pages_v1 = await response.parse()
        assert_matches_type(PagesV1RenderCreateResponse, pages_v1, path=["response"])

    @parametrize
    async def test_streaming_response_render_create(self, async_client: AsyncUnlayer) -> None:
        async with async_client.pages_v1.with_streaming_response.render_create(
            design={
                "counters": "bar",
                "body": "bar",
            },
