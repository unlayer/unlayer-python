...
class TestEvents:
    ...
    def test_method_retrieve(self, client: Unlayer) -> None:
        event = client.emails.events.retrieve(
            "id",
        )
    ...
    def test_raw_response_retrieve(self, client: Unlayer) -> None:
        response = client.emails.events.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Unlayer) -> None:
        with client.emails.events.with_streaming_response.retrieve(
            "id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.emails.events.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncEvents:
    ...
    async def test_method_retrieve(self, async_client: AsyncUnlayer) -> None:
        event = await async_client.emails.events.retrieve(
            "id",
        )
        assert_matches_type(EventRetrieveResponse, event, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.emails.events.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncUnlayer) -> None:
        async with async_client.emails.events.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.emails.events.with_raw_response.retrieve(
                "",
            )
