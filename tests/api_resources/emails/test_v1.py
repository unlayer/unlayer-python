...
class TestV1:
    ...
    def test_method_emails_retrieve(self, client: Unlayer) -> None:
        v1 = client.emails.v1.emails_retrieve(
            "id",
        )
        assert_matches_type(V1EmailsRetrieveResponse, v1, path=["response"])

    @parametrize
    def test_raw_response_emails_retrieve(self, client: Unlayer) -> None:
        response = client.emails.v1.with_raw_response.emails_retrieve(
            "id",
        )
    ...
    def test_streaming_response_emails_retrieve(self, client: Unlayer) -> None:
        with client.emails.v1.with_streaming_response.emails_retrieve(
            "id",
        ) as response:
    ...
    def test_path_params_emails_retrieve(self, client: Unlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.emails.v1.with_raw_response.emails_retrieve(
                "",
            )
...
class TestAsyncV1:
    ...
    async def test_method_emails_retrieve(self, async_client: AsyncUnlayer) -> None:
        v1 = await async_client.emails.v1.emails_retrieve(
            "id",
        )
        assert_matches_type(V1EmailsRetrieveResponse, v1, path=["response"])
    ...
    async def test_raw_response_emails_retrieve(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.emails.v1.with_raw_response.emails_retrieve(
            "id",
        )
    ...
    async def test_streaming_response_emails_retrieve(self, async_client: AsyncUnlayer) -> None:
        async with async_client.emails.v1.with_streaming_response.emails_retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_emails_retrieve(self, async_client: AsyncUnlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.emails.v1.with_raw_response.emails_retrieve(
                "",
            )
