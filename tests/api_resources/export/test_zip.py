...
class TestZip:
    ...
    def test_method_retrieve(self, client: Unlayer) -> None:
        zip = client.export.zip.retrieve(
            project_id="projectId",
        )
        assert_matches_type(ZipRetrieveResponse, zip, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Unlayer) -> None:
        response = client.export.zip.with_raw_response.retrieve(
            project_id="projectId",
        )
    ...
    def test_streaming_response_retrieve(self, client: Unlayer) -> None:
        with client.export.zip.with_streaming_response.retrieve(
            project_id="projectId",
        ) as response:
...
class TestAsyncZip:
    ...
    async def test_method_retrieve(self, async_client: AsyncUnlayer) -> None:
        zip = await async_client.export.zip.retrieve(
            project_id="projectId",
        )
        assert_matches_type(ZipRetrieveResponse, zip, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncUnlayer) -> None:
        response = await async_client.export.zip.with_raw_response.retrieve(
            project_id="projectId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncUnlayer) -> None:
        async with async_client.export.zip.with_streaming_response.retrieve(
            project_id="projectId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
