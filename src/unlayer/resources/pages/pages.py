...
class PagesResourceWithRawResponse:
    ...
    def v1(self) -> V1ResourceWithRawResponse:
        return V1ResourceWithRawResponse(self._pages.v1)
...
class AsyncPagesResourceWithRawResponse:
    ...
    def v1(self) -> AsyncV1ResourceWithRawResponse:
        return AsyncV1ResourceWithRawResponse(self._pages.v1)
...
class PagesResourceWithStreamingResponse:
    ...
    def v1(self) -> V1ResourceWithStreamingResponse:
        return V1ResourceWithStreamingResponse(self._pages.v1)
...
class AsyncPagesResourceWithStreamingResponse:
    ...
    def v1(self) -> AsyncV1ResourceWithStreamingResponse:
        return AsyncV1ResourceWithStreamingResponse(self._pages.v1)
