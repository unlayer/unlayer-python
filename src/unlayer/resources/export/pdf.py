...
from ...types.export import pdf_retrieve_params
from ...types.export.pdf_retrieve_response import PdfRetrieveResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"project_id": project_id}, pdf_retrieve_params.PdfRetrieveParams),
            ),
            cast_to=PdfRetrieveResponse,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"project_id": project_id}, pdf_retrieve_params.PdfRetrieveParams),
            ),
            cast_to=PdfRetrieveResponse,
        )
