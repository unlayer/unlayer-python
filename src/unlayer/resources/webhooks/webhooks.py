...
from .rotate_secret import (
    RotateSecretResource,
    AsyncRotateSecretResource,
    RotateSecretResourceWithRawResponse,
    AsyncRotateSecretResourceWithRawResponse,
    RotateSecretResourceWithStreamingResponse,
    AsyncRotateSecretResourceWithStreamingResponse,
)
...
class WebhooksResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        events: List[Literal["email.sent", "email.delivered", "email.bounced", "email.complained"]] | Omit = omit,
        ...
        A signing secret is auto-generated and returned
        ...
        Args:
          ...
          events: Event types to subscribe to. If omitted or empty, all events are sent.
    ...
    def update(
        ...
        *,
        ...
        Args:
          active: Whether the webhook is actively receiving events
