        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                v1_send_create_params.V1SendCreateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=V1SendCreateResponse,
        )
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                v1_send_template_template_params.V1SendTemplateTemplateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=V1SendTemplateTemplateResponse,
        )
