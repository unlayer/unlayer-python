...
__all__ = ["TemplateCreateParams", "Attachment"]
...
class TemplateCreateParams(TypedDict, total=False):
    ...
    Up to 9 printable-ASCII X-\\** headers are allowed. Header names may contain up to
    126 characters and each name plus value may contain up to 996 characters.
    """
    ...
    Supports {{variable}} merge syntax. Defaults to template name if omitted.
    """
