...
__all__ = ["ExportPdfCreateParams"]


class ExportPdfCreateParams(TypedDict, total=False):
    ...
    content_width: Annotated[Union[float, Literal["full"]], PropertyInfo(alias="contentWidth")]
